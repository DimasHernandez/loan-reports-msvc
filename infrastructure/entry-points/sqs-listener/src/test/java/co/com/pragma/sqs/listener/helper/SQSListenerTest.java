...
import co.com.pragma.sqs.listener.SQSLoanApprovedProcessor;
import co.com.pragma.sqs.listener.config.SQSLoanApprovedProperties;
...
//
//        var sqsProperties = new SQSLoanApprovedProperties(
//                "us-east-1",
//                "http://localhost:4566",
...
//                .client(asyncClient)
//                .properties(sqsLoanApprovedProperties)
//                .processor(new SQSLoanApprovedProcessor())
//                .operation("operation")
//                .build();
//
